...
class IndexController extends Controller
{
    ...
    public function index()
    {
        ...
        $bookingInfo = Booking::with('asset.location.building', 'asset.location.region', 'customer')->where('active', true)->where('time_from', '<=', date('Y-m-d', strtotime('+14 days')))->orderBy('time_from', 'asc')->get();
