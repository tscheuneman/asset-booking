<div class="container">
<!-- START /asuthemes/4.6/headers/default.shtml -->
...
<div id="asu_hdr" class="asu_hdr_white">
    ...
    <br style="clear:left" />
    <a style="float:left; color:#000; margin:15px 0; text-indent:10px; font-size:24px;" href="#">Deez Nuts</a>
    <br style="clear:left" />
</div>
...
<!-- END /asuthemes/4.6/headers/default.shtml -->
